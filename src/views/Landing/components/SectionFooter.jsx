        ...
        <ContentContainer>
          ...
          <IconsContainer>
            ...
            <img
              ...
              alt="Contact Icon."
              onClick={() =>
                window.open('https://www.instagram.com/mailchecker')
              }
            />
            <img
              className="icons"
            ...
            <img
              ...
              alt="Contact Icon."
              onClick={() =>
                window.open('https://www.linkedin.com/company/mailchecker')
              }
            />
            <img
              className="icons"
              src={TwitterIcon}
              alt="Contact Icon."
              onClick={() => window.open('https://twitter.com/mailchecker')}
            />
            <img
              className="icons"
              src={GithubIcon}
              alt="Contact Icon."
              onClick={() => window.open('https://github.com/mailchecker')}
            />
            <img
              className="icons"
              src={EmailIcon}
              alt="Contact Icon."
              onClick={() => window.open('mailto:hello@mailchecker.org')}
            />
            {/* eslint-enable */}
          </IconsContainer>

          <CopyrightContainer>
            <div className="equithonCopyright">© MailChecker 2019</div>
          </CopyrightContainer>
