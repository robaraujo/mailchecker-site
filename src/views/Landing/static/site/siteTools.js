...
import SFProDisplayBlackOTF from '../fonts/SF-Pro-Display-Black.otf';
import SFProDisplayBoldOTF from '../fonts/SF-Pro-Display-Bold.otf';
import SFProDisplayHeavyOTF from '../fonts/SF-Pro-Display-Heavy.otf';
import SFProDisplayLightOTF from '../fonts/SF-Pro-Display-Light.otf';
import SFProDisplayMediumOTF from '../fonts/SF-Pro-Display-Medium.otf';
import SFProDisplayRegularOTF from '../fonts/SF-Pro-Display-Regular.otf';
import SFProDisplaySemiboldOTF from '../fonts/SF-Pro-Display-Semibold.otf';
import SFProDisplayThinOTF from '../fonts/SF-Pro-Display-Thin.otf';
